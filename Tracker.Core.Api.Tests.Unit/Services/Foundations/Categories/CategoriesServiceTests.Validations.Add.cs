...
namespace Tracker.Core.Api.Tests.Unit.Services.Foundations.Categories
{
    public partial class CategoriesServiceTests
    {
        ...
        public async Task ShouldThrowValidationExceptionOnAddIfAuditPropertiesAreNotSameAndLogItAsync()
        {
            ...
            Category randomCategory = CreateRandomCategory(now);
            Category invalidCategory = randomCategory;
            invalidCategory.CreatedBy = GetRandomString();
            invalidCategory.UpdatedBy = GetRandomString();
            invalidCategory.CreatedDate = now;
            invalidCategory.UpdatedDate = GetRandomDateTimeOffset();
        ...
        public async Task ShouldThrowValidationExceptionOnAddIfCreatedDateIsNotRecentAndLogItAsync(int invalidSeconds)
        {
            ...
            invalidCategory.CreatedDate = invalidDate;
            invalidCategory.UpdatedDate = invalidDate;
